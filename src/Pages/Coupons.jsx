                                    ...
                                    <div className='max-w-xl mx-auto flex mt-10 md:-mt-20'>
                                      <button className='btn btn-primary mr-4 text-xl font-medium'>Brands</button>
                                        <Marquee pauseOnHover>
                                            {data.map(coupon => <Link key={coupon._id}  to={`/getCode/${coupon._id}`}><img className='w-10 h-10 mr-5 rounded-full' src={coupon.brand_logo}/></Link>)}
                                        </Marquee>
                                        </div>
                                      ...
                                      {data.slice(0,5).map(coupon => <CouponsCard coupon={coupon} key={coupon._id}></CouponsCard>)}                      
                                        </div>
